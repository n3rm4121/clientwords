    ...
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col items-center p-4">
      <div className="w-full max-w-4xl space-y-8 py-8">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-indigo-400">1. Information We Collect</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-indigo-400">2. How We Use Your Information</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-indigo-400">3. Information Sharing and Disclosure</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-indigo-400">4. Data Security</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-indigo-400">5. Your Rights and Choices</h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-indigo-400">6. Changes to This Policy</h2>
          <p>
